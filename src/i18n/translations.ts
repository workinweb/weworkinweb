...
export const translations = {
  en: {
    ...
    "services.subtitle":
      "From design to deployment, we provide comprehensive web solutions that help your business thrive in the digital world.",
    ...
    "services.websiteDesign.title": "Website Design",
    ...
    "services.customDevelopment.title": "Custom Development",
    ...
    "services.seo.title": "SEO & Analytics",
    ...
    "services.hosting.title": "Fast & Reliable Hosting",
    ...
    "pricing.title": "Investment Options",
    ...
    "pricing.basic.name": "Basic Landing",
    ...
    "pricing.basic.features": [
      ...
      "Basic SEO setup",
      "Hosting available (starts at $20 / monthly)",
      "Post-deployment changes: has a quote",
    ],
    "pricing.basic.notes": [
      "Price range: $1,000 - $2,000",
      "Hosting price depends on monthly traffic and resource usage",
    ...
    "pricing.growth.description":
      "Expand your digital presence with more features and support",
    ...
    "pricing.custom.name": "Custom Solution",
    "pricing.custom.description":
      "Full-scale web solutions for established businesses",
    ...
    "features.subtitle":
      "Preview Your Future Online Presence. Explore our showcase of professional landing page designs to envision how your business could look online",

    "features.contactForm.title": "Contact Form",
    "features.contactForm.description":
      "Seamlessly connect with your customers through our intuitive contact form. Receive inquiries directly to your inbox.",

    "features.mapView.title": "Map View",
    "features.mapView.description":
      "Interactive map integration to help customers find your physical locations easily. Perfect for businesses with multiple stores.",

    "features.loading.title": "Loading Screen Animation",
    "features.loading.description":
      "Smooth and engaging loading animations to keep your users entertained while content loads. Enhances the overall user experience.",

    "features.multilingual.title": "Multilingual Support",
    "features.multilingual.description":
      "Reach a global audience by offering your content in multiple languages. Built-in translation support makes it easy to expand your reach.",

    "features.liveChat.title": "Live Chat Integration",
    "features.liveChat.description":
      "Integrate popular third-party live chat and chatbot solutions to provide real-time customer support and automated assistance to your website visitors.",
    ...
    "features.card.contactForm.title": "Contact Form",
    "features.card.contactForm.description":
      "A customizable contact form solution that helps you connect with your users while protecting against spam.",
    "features.card.contactForm.subtitle": "Key Features",
    ...
    "features.card.mapView.title": "Map View",
    "features.card.mapView.description":
      "An interactive map view that makes it easy for customers to locate your business and get directions.",
    "features.card.mapView.subtitle": "Key Features",
    ...
    "features.card.multilingual.title": "Multi-Language Support",
    ...
    "features.card.liveChat.title": "Live-Chat / Chat-bot Integration",
    "features.card.liveChat.description":
      "A live-chat or chat-bot integration feature that allows your website to user to chat with your business.",
    "features.card.liveChat.subtitle": "Key Features",
    ...
    "features.card.darkMode.title": "Dark Mode / Themes",
    "features.card.darkMode.description":
      "A dark mode or theme feature that allows your website to be easily customized to your users' preferences.",
    "features.card.darkMode.subtitle": "Key Features",
    ...
    "showcase.search.placeholder": "Search templates...",
    "showcase.category.all": "All",
  ...
  es: {
    ...
    "pricing.custom.notes": [
      ...
      "Planes de mantenimiento flexibles disponibles",
    ],
